...
For this sesison we will be using the streamlit python package that is used to build data driven web apps using very less lines of code compared to Flask and Django. We can also display videos, calendars and dropdowns with single line of code that I will be demonstrating later.
